        ...
        <>
          ...
          <div className="wrapper">
            ...
            <main className="content">
              ...
              <div className="block blockBorder">
                <h2 className="content-title dark-title">
                  Find out our streamers
                </h2>
          ...
          <footer className="footer">
            ...
            <div className="footerBottomBlock">
              ...
              <p>
                This server is a test option of the game lineage 2 and is
                intended only for the acquaintance of players.
              </p>
